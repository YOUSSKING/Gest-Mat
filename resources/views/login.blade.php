        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4 col-md-offset-4">
                    ...
                    <h2>GSMP2I</h2>
                    <img src="../assets/img/instat.png" alt="">
                </div>
                        <div class="panel-heading">
                            <h3 class="panel-title">Veuillez saisir vos identifiants.</h3>
                        </div>
            ...
            <footer class="panel-footer ">
                <div class="text-center">
                    <p> GSMP2I (Gestion, Suivi et Monitoring du Parc Informatique de l'INSTAT) </p>
                    <p> Copyrigth © INSTAT 2023-2024 </p>
                </div>
            </footer>
        </div>

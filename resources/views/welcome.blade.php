        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
                <div class="navbar-header">
                    <a class="navbar-brand" href="index.html">GSMP2I</a>
                </div>
            ...
            <aside class="sidebar navbar-default" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="index.html" class="active"><i class="fa fa-dashboard fa-fw"></i> TABLEAU DE BORD</a>
                        </li>
                        <li>
                            <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> GRAPHIQUES<span class="fa arrow"></span></a>
                        ...
                        <li>
                            <a href="#"><i class="fa fa-cogs fa-fw"></i> GESTION DES MATERIELS<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="panels-wells.html">Type Materiel</a>
                                </li>
                                <li>
                                    <a href="buttons.html">Modèle</a>
                                </li>
                                <li>
                                    <a href="notifications.html">Marque</a>
                                </li>
                                <li>
                        ...
                        <li>
                            <a href="#"><i class="fa fa-bars fa-fw"></i> GESTION DU PARC<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                        ...
                        <li>
                            <a href="#"><i class="fa fa-user-secret fa-fw"></i> ADMINISTRATEUR<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="blank.html">Blank Page</a>
                                </li>
                        ...
                        <li>
                            <a href="#"><i class="fa fa-user-md fa-fw"></i> PERSONNEL<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="blank.html">Blank Page</a>
                                </li>
                                ...
                                <div class="panel-heading">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-9 text-right">
                                            ...
                                            <div>Total Matériels Affectés</div>
                                        </div>
                                    </div>
                                </div>
                                <a href="#">
                                ...
                                <div class="panel-heading">
                                    <div class="row">
                                        ...
                                        <div class="col-xs-9 text-right">
                                            ...
                                            <div>Total Matériels Non Affectés</div>
                                        </div>
                                    </div>
                                </div>
                                <a href="#">
